 ...
 * @author mari
 */
public class FormVacio extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVacio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
